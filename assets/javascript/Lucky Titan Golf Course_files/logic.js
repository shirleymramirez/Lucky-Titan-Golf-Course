$(document).ready(function() {
    ...
    // set date and time for the player information form
    // set default time to current date
    $('#dateTimePicker').datetimepicker({  
         minDate:new Date()
    });

    // set date and time for the modal form
    // set default time to current datetimepicker
    ...
    $("#inputForm").on("submit", function() {
        ...
        reservationDate = $("#dateTimePicker").data("DateTimePicker").date();
        ...
        database.ref().push({
            firstName: firstName,
            lastName: lastName,
            reservationDate: reservationDate.format("MM/DD/YYYY h:mm a"),
    ...
    database.ref().on("child_added", function(childSnapshot) {
            ...
            var dateReserved = moment(item.reservationDate).format("MM/DD/YYYY h:mm a");
            ...
            $("#reservationLists").append('<tr class="' + childSnapshot.key + '">' +
                ...
                '<td id="reservedDate">' + dateReserved + "</td>" +
    ...
    $("body").on("click", ".edit-row", function(event) {
        ...
        database.ref().child(key).once('value')
            .then(function(snapshot) {
                ...
                $("#modalDateTimePicker").data("DateTimePicker").date(value.reservationDate);
    ...
    $("#editForm").on("submit", function(event) {
        ...
        var reservationDate = $("#modalDateTimePicker").data("DateTimePicker").date();
